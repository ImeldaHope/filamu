...
const ShowView = () => {
  return (
    <>    
      <hero>
        <div class="flex flex-row justify-between items-center border-b-2 border-x mx-5 mt-3">
          <div class="flex-grow"> 
            <div class="p-10">
            ...
            <div class="flex flex-wrap md:w-[50%]">
        ...
        <div>
          ...
          <div class="flex flex-row items-center justify-between overflow-x-auto no-scrollbar mx-5">
            ...
            <div class="flex flex-row relative p-8 mx-5">
              ...
              <div class="absolute top-0 -right-12 transform translate-y-1/2 w-32 h-44 rounded-lg shadow bg-gradient-to-r from-[#FD1D1D] to-red-200"></div>
            </div>                
            <div class="flex flex-row relative p-8 mx-5">
